...
export interface RollHistoryEntry { id: string; type: "humanity_loss" | "attack" | "damage" | "evasion" | "received_damage" | "skill_check"; label: string; characterId: string; expression: string; rolls: number[]; total: number; timestamp: string; cyberwareId?: string; cyberwareName?: string; humanityBefore?: number; humanityAfter?: number; attackType?: import("@/types/attack").AttackType; weaponId?: string; attackId?: string; damageDice?: string; stat?: { id: AttributeName; value: number }; skill?: { id: string; value: number }; modifiers?: import("@/types/attack").AttackModifier[]; hpBefore?: number; hpAfter?: number; amount?: number; hitLocation?: import("@/types/combat").HitLocation; armorSPBefore?: number; armorSPAfter?: number; damageAbsorbed?: number; damageToHP?: number; }
